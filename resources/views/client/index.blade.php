                    ...
                    <div class="trending__product">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4">
                                <div class="btn__all">
                                    <a href="{{route('client.theloai', 'chieu-rap-nuoc-ngoai')}}" class="primary-btn">Xem tất cả<span class="arrow_right"></span></a>
                                </div>
                            </div>
                        </div>
                        <div class="row">
...
{{--                                            <div onclick="showModalDetail({{$item->id}})" class="comment">Xem phim</div>--}}
                    ...
                    <div class="popular__product">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4">
                                <div class="btn__all">
                                    <a href="{{route('client.theloai', 'chieu-rap-viet')}}" class="primary-btn">Xem tất cả<span class="arrow_right"></span></a>
                                </div>
                            </div>
                        </div>
                        <div class="row">
...
{{--                                            <div onclick="showModalDetail({{$item->id}})" class="comment">Xem phim</div>--}}
                    ...
                    <div class="popular__product">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4">
                                <div class="btn__all">
                                    <a href="{{route('client.theloai', 'phim-hay-khac')}}" class="primary-btn">Xem tất cả<span class="arrow_right"></span></a>
                                </div>
                            </div>
                        </div>
                        <div class="row">
