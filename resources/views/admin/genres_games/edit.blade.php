    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('admin.genre_game.update', $genre->id) }}" class="forms-sample">
                    @csrf
                    @method('PUT')
                    <div class="form-group">
                        <label for="exampleInputName1">Name</label>
                        <input type="text" value="{{$genre->name}}" onkeyup="ChangeToSlug()" name="name" class="form-control" id="title" placeholder="Title">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputName1">Slug</label>
                        <input type="text" value="{{$genre->slug}}" name="slug" class="form-control" id="slug" placeholder="slug">
                    </div>
