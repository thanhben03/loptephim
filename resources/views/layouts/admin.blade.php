...
<head>
    ...
    <link rel="stylesheet" href="{{asset('a_admin/assets/css/myStyle.css')}}">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="ui-basic">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link" href="{{route("admin.movie.create")}}">Thêm</a></li>
                            <li class="nav-item"> <a class="nav-link" href="{{route('admin.movie.index')}}">Danh sách</a></li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item">
                    ...
                    <div class="collapse" id="form-elements">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"><a class="nav-link" href="{{route("admin.genre.create")}}">Thêm</a></li>
                            <li class="nav-item"><a class="nav-link" href="{{route("admin.genre.index")}}">Danh sách</a></li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item">
